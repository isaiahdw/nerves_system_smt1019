defmodule NervesSystemSmt1019.MixProject do
  use Mix.Project

  @github_organization "isaiahdw"
  @app :nerves_system_smt1019
  ...
  def project do
    [
      app: @app,
      version: @version,
      # OTP 28 requires Elixir 1.17 or later.
      elixir: "~> 1.17",
  ...
  defp description do
    "Nerves system for the SMT1019 smart-home panel (Rockchip RK3576)"
  end
